...
function getData() {
    ...
    // fetch data using AJAX - returns JS promise

    $.ajax(BASE_URL).then(function (data) {

        // take the returned data and assign it to a global state variable
        pokemonData = data;
        // call render to visualize it to the DOM - must be in success callback
        render();
...
//backend and react use with render - transfers the state of our application to the DOM - Output
function render() {
